...
- To strengthen my practical skills in cloud computing and CI/CD,  which are essential for modern software development roles.
- To build real-world experience deploying applications with AWS, helping me grow as a full-stack developer and improve my career opportunities.
...
- Faced challenges configuring AWS services correctly (such as IAM permissions and deployment settings), which I resolved by carefully reviewing documentation and applying least-privilege access principles.
...
3. Install dependencies:
    ...
    mvn install
    ```
4. If dependencies fail to install, ensure all required tools (e.g., Java, Maven, Node.js) are correctly installed and added to your system PATH.
5. If GitHub push or authentication fails, verify your Personal Access Token is valid and has the correct permissions.
...
Rimon - [rimon.alqoshi@gmail.com](mailto:rimon.alqoshi@gmail.com)
